                ...
                Column(
                  ...
                  children: [
                    SelectableText("Phone Number", style: TextStyle(color: Colors.white,
                        ...
                        fontFamily: fontFamily,
                        fontSize: 14.sp),),
                    SelectableText("9949155666", style: TextStyle(color: Colors.white,
                        fontWeight: FontWeight.normal,
                        fontFamily: fontFamily,
                        fontSize: 14.sp),)
          ...
          Row(
            ...
            children: [
              Column(
                ...
                children:  const [
                  SelectableText("Address",style: TextStyle(color: Colors.white,fontSize: 17,fontWeight: FontWeight.normal,fontFamily: fontFamily),),
                  SizedBox(height: 5,),
                  SelectableText("D.No: 4-53, Near Sai Baba Temple \nGopi Nagar Park, Kakinada.",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 15),)
              ...
              Column(
                ...
                children: [
                  SelectableText("Phone Number",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 17),),
                  SizedBox(height: 5,),
                  SelectableText("9949155666",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 15),)
              ...
              Column(
                ...
                children: [
                  SelectableText("E-Mail",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 17),),
                  SizedBox(height: 5,),
                  SelectableText("labhamsubham.8@gmail.com",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 15),)
                ],
              ),
            ],
          ),
            ...
            child: FittedBox(
              child: Row(
                ...
                children: [
                  Container(
                      padding:  sizingInformation.deviceScreenType == DeviceScreenType.desktop ?const EdgeInsets.symmetric(horizontal: 150): null,
                      child: FittedBox(child:  Text("© Copyright 2022 LABHAM SUBHAM. All Rights Reserved.",style: TextStyle(color: Colors.white,fontWeight: FontWeight.normal,fontFamily: fontFamily,fontSize: 13),))),
