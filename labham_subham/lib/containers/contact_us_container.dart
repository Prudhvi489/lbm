...
class _ContactUsContainerState extends State<ContactUsContainer> {
  ...
  Future sendEmail(
    ...
    if (responce.statusCode == 200) {
      ...
      awesomeDialog(
          context,
          "Message successfully delivered to the Labham Subham team. They will contact you shortly.",
          dialogueWidth);
    } else {
      nameController.clear();
      purposeOfPoojaController.clear();
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              color: sindhurColor,
              child:  SelectableText("Working Hours: 8.00AM - 6.00PM", style: TextStyle(color: Colors.white,
                  fontSize: 14.sp,
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: MediaQuery.of(context).size.height > 750
            ? separatewidgetConstactus(sizingInformation)
            : SingleChildScrollView(
                child: separatewidgetConstactus(sizingInformation),
              ),
      ),
    );
  }

  Widget separatewidgetConstactus(sizingInformation) {
    return Column(
